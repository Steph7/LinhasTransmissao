...
Linha de transmissão é um sistema utilizado para transmissão de energia. Guiada de uma fonte geradora para uma carga consumidora, podendo ser uma guia de onda, um cabo coaxial ou fios paralelos ou torcidos, sendo a forma mais utilizada para o transporte de energia elétrica que é uma transmissão de alta potência, geralmente usando corrente alternada. 

$~$

<center>
<a href = "https://images.app.goo.gl/f42MW5bQs8S96SdG6">
![](images/linhas-transmissao.gif){width=25%}
</a>
</center>
